...
public class Client extends Thread{
	...
	public void run(){
    	...
    	System.out.println("Client " + num + ": Running time to "+ Benchmarking.operations + " put operations: " + (stop-start) + "ms.");
    	...
    	System.out.println("Client " + num + ": Running time to "+ Benchmarking.operations + " get operations: " + (stop-start) + "ms.");
    	...
    	System.out.println("Client " + num + ": Running time to "+ Benchmarking.operations + " del operations: " + (stop-start) + "ms.");
